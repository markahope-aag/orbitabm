...
export function CompetitiveLandscapeSection({ content, onRefresh }: CompetitiveLandscapeSectionProps) {
  return (
    <SectionBlock
    ...
    >
      <div className="prose prose-sm prose-slate max-w-none">
        {content?.content ? (
          ...
          <p className="text-slate-400 italic">Loading competitor data...</p>
        )}
      </div>
    </SectionBlock>
  )
